...
class satis_irsaliye_detay_rapor_page extends StatefulWidget {
  ...
  const satis_irsaliye_detay_rapor_page(
      {super.key,
  ...
  @override
  State<satis_irsaliye_detay_rapor_page> createState() =>
      _satis_irsaliye_detay_rapor_pageState();
}

class _satis_irsaliye_detay_rapor_pageState
    extends State<satis_irsaliye_detay_rapor_page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: MyAppBar(
        height: 50,
        title: 'Satış İrsaliye Detay Raporu',
      ),
      body: Column(
        children: [
          Padding(
