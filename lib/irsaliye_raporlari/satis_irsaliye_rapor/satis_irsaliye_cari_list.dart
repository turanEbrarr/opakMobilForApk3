...
class satis_irsaliye_cari_list_page extends StatefulWidget {
  const satis_irsaliye_cari_list_page({required this.widgetListBelgeSira});

  final int widgetListBelgeSira;

  @override
  State<satis_irsaliye_cari_list_page> createState() =>
      _satis_irsaliye_cari_list_pageState();
}

class _satis_irsaliye_cari_list_pageState
    extends State<satis_irsaliye_cari_list_page> {
