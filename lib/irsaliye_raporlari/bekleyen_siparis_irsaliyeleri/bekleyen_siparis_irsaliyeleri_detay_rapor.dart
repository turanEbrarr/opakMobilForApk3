...
class bekleyen_siparis_irsaliyeleri_detay_rapor_page extends StatefulWidget {
  ...
  const bekleyen_siparis_irsaliyeleri_detay_rapor_page(
      {super.key,
  ...
  @override
  State<bekleyen_siparis_irsaliyeleri_detay_rapor_page> createState() =>
      _bekleyen_siparis_irsaliyeleri_detay_rapor_pageState();
}

class _bekleyen_siparis_irsaliyeleri_detay_rapor_pageState
    extends State<bekleyen_siparis_irsaliyeleri_detay_rapor_page> {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
                builder: (context) => irsaliyelerPdfOnizleme(
                      ...
                      baslik: 'Bekleyen Sipariş İrsaliye Detay',
                    )),
          );
        },
      ),
