...
class kapatilmamis_fat_cari_list_page extends StatefulWidget {
  const kapatilmamis_fat_cari_list_page({required this.widgetListBelgeSira});

  final int widgetListBelgeSira;

  @override
  State<kapatilmamis_fat_cari_list_page> createState() =>
      _kapatilmamis_fat_cari_list_pageState();
}

class _kapatilmamis_fat_cari_list_pageState
    extends State<kapatilmamis_fat_cari_list_page> {
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return LoadingSpinner(
                                            color: Colors.black,
                                            message:
                                                "Seçili Cari İçin Kapatılmamış Faturalar Hazırlanıyor...",
                                          );
                                        },
                                      );
                                      ...
                                      List<List<dynamic>> gelen = await bs
                                          .getirKapatilmamisFaturalarRapor(
                                      ...
                                      if (gelen[0].length == 1 &&
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: ((context) =>
                                                kapatilmamis_fatura_rapor_page(
                                                  cariKart: cariKart,
                                                  gelenFiltre: cek,
