...
class valor_rapor_page extends StatefulWidget {
  ...
  @override
  State<valor_rapor_page> createState() => _valor_rapor_pageState();
}

class _valor_rapor_pageState extends State<valor_rapor_page> {
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
                builder: (context) => valorRaporuPdfOnizleme(
