...
class valor_cari_list_page extends StatefulWidget {
  const valor_cari_list_page({required this.widgetListBelgeSira});

  final int widgetListBelgeSira;

  @override
  State<valor_cari_list_page> createState() => _valor_cari_list_pageState();
}

class _valor_cari_list_pageState extends State<valor_cari_list_page> {
