...
import 'valor_raporu_make_pdf.dart';

class valorRaporuPdfOnizleme extends StatefulWidget {
  List<List<String>>? satirlar;
  List<String>? kolonlar;
  final Cari? caraiKart;

  valorRaporuPdfOnizleme({
    required this.satirlar,
    required this.kolonlar,required this.caraiKart,
  });

  @override
  State<valorRaporuPdfOnizleme> createState() => _valorRaporuPdfOnizlemeState();
}

class _valorRaporuPdfOnizlemeState extends State<valorRaporuPdfOnizleme> {
