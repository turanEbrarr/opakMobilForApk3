class CariKosulModel {
    ...
    CariKosulModel({this.ID, this.CARIKOD, this.GRUPKODU, this.FIYAT, this.ISK1, this.ISK2, this.ISK3, this.ISK4, this.ISK5, this.ISK6, this.SABITFIYAT}); 

    CariKosulModel.fromJson(Map<String, dynamic> json) {
