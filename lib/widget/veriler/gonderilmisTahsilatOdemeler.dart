...
import 'gonderilmisTahsilatOdemelerDetay.dart';
import 'package:intl/intl.dart';
import '../../widget/customAlertDialog.dart';

class gonderilmisTahsilatOdemeler extends StatefulWidget {
  final List<Tahsilat> gidenFisler;
  const gonderilmisTahsilatOdemeler({super.key, required this.gidenFisler});

  @override
  State<gonderilmisTahsilatOdemeler> createState() =>
      _gonderilmisTahsilatOdemelerState();
}

class _gonderilmisTahsilatOdemelerState
    extends State<gonderilmisTahsilatOdemeler> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(height: 50, title: "Gönderilmiş Tahsilat Ve Ödemeler"),
      body: Column(
        children: [
          Column(
            children: [
                          ...
                          setState(() async {
                            ...
                            try {
                              gidenTarihliFisler = (await fisEx
                                  .listTarihliGidenTahsilatleriGetir(
