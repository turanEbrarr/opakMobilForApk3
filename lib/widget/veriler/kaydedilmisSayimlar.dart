...
import 'kaydedilmisSayimlarDetay.dart';
import 'package:intl/intl.dart';
import '../../widget/customAlertDialog.dart';
import '../../controllers/depoController.dart';
import '../../Depo Transfer/depo.dart';
import '../veriler/kaydedilmisSayimlarDetay.dart';

class kaydedilmisSayimlar extends StatefulWidget {
  final List<Sayim> gidenFisler;
  const kaydedilmisSayimlar({super.key, required this.gidenFisler});

  @override
  State<kaydedilmisSayimlar> createState() => _kaydedilmisSayimlarState();
}

class _kaydedilmisSayimlarState extends State<kaydedilmisSayimlar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(height: 50, title: "Kaydedilmiş Sayımlar"),
      body: Column(
        children: [
          Column(
            children: [
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          setState(() async {
                            ...
                            try {
                              gidenTarihliFisler =
                                  await fisEx.listTarihliKaydedilenFisleriGetir(
                                      basTar, bitTar);
