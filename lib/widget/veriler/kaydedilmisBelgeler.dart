...
import 'kaydedilmisBelgelerDetay.dart';
import 'package:intl/intl.dart';
import '../../widget/customAlertDialog.dart';

class kaydedilmisBelgeler extends StatefulWidget {
  final List<Fis> gidenFisler;
  const kaydedilmisBelgeler({super.key, required this.gidenFisler});

  @override
  State<kaydedilmisBelgeler> createState() => _kaydedilmisBelgelerState();
}

class _kaydedilmisBelgelerState extends State<kaydedilmisBelgeler> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(height: 50, title: "Kaydedilmiş Belgeler"),
      body: Column(
        children: [
          Column(
            children: [
                          ...
                          setState(() async {
                            ...
                            try {
                              gidenTarihliFisler = await fisEx
                                  .listTarihliKaydedilenFisleriGetir(basTar, bitTar);
