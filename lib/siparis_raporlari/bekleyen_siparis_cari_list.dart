...
import 'package:opak_mobil_v2/siparis_raporlari/bekleyen_siparis_list.dart';
...
class bekleyen_siparis_cari_list_page extends StatefulWidget {
  const bekleyen_siparis_cari_list_page({required this.widgetListBelgeSira});

  final int widgetListBelgeSira;

  @override
  State<bekleyen_siparis_cari_list_page> createState() =>
      _bekleyen_siparis_cari_list_pageState();
}

class _bekleyen_siparis_cari_list_pageState
    extends State<bekleyen_siparis_cari_list_page> {
