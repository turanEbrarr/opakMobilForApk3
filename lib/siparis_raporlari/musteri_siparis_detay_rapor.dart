...
class musteri_siparis_detay_rapor extends StatefulWidget {
  ...
  const musteri_siparis_detay_rapor(
      {super.key,
  ...
  @override
  State<musteri_siparis_detay_rapor> createState() =>
      _musteri_siparis_detay_raporState();
}

class _musteri_siparis_detay_raporState
    extends State<musteri_siparis_detay_rapor> {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
                builder: (context) => faturalarPdfOnizleme(
                      ...
                      faturaID: widget.faturaID, baslik: 'Müşteri Sipariş Detay',
                    )),
          );
        },
      ),
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            ...
                            await SharedPrefsHelper.filtreKaydet(
                                secilenKolonlar, "raporMusteriSiparisListesiDetay");
                                   ustfiltre = false;
                            setState(() {});
                          },
