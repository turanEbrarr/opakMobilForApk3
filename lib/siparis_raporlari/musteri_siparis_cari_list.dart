...
import 'package:opak_mobil_v2/siparis_raporlari/musteri_siparis_list.dart';
...
class musteri_siparis_cari_list_page extends StatefulWidget {
  const musteri_siparis_cari_list_page({required this.widgetListBelgeSira});

  final int widgetListBelgeSira;

  @override
  State<musteri_siparis_cari_list_page> createState() =>
      _musteri_siparis_cari_list_pageState();
}

class _musteri_siparis_cari_list_pageState
    extends State<musteri_siparis_cari_list_page> {
